...
document.body.appendChild(crttable)
crttable.id="stylegiven"
document.getElementById("stylegiven").style.border="1";
//document.getElementById("stylegiven").style.borderCollapse = "collapse";
